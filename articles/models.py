...
class Category(models.Model):
    ...
    entitle = models.CharField(max_length=200, verbose_name=("عنوان دسته‌بندی انگلیسی"))
...
class Article(models.Model):
    ...
    entitle = models.CharField(max_length=200, verbose_name=("عنوان مقاله انگلیسی"), help_text=("عنوان مقاله را وارد کنید انگلیسی"))
    ...
    endescription = HTMLField(verbose_name=("مقاله انگلیسی"), help_text=("محتوای مقاله را وارد کنید انگلیسی"))
